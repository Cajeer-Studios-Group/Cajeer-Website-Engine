...
<body>
	...
	<div class="main">
		<form class="form" method="POST" action="/account/authorization/">
			...
			<p><input type="checkbox" name="remember"> <? echo LANGSITE96; ?></p><br>
			<input type="submit" value="<? echo LANGSITE97; ?>" class="button-submit" name="enter">
			<div class="ease"></div>
		</form>
	</div>
	<footer>
